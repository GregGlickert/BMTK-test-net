...
#define taun _p[3]
#define taun_columnindex 3
#define gm _p[4]
#define gm_columnindex 4
#define n _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 imCA3 /home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/imCA3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/imCA3.mod";
static const char* nmodl_file_text = 
