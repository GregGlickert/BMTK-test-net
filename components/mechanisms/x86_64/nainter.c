...
#define mv_05 _p[1]
#define mv_05_columnindex 1
#define hv_05 _p[2]
#define hv_05_columnindex 2
#define mtau_inv _p[3]
#define mtau_inv_columnindex 3
#define htau_inv _p[4]
#define htau_inv_columnindex 4
#define ina _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nainter /home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/nainter.mod\n");
...
double malf ( _threadargsprotocomma_ double _lv ) {
   double _lmalf;
 _lmalf = mtau_inv * exp ( ( _lv - mv_05 ) / 11.75 ) ;
...
double mbet ( _threadargsprotocomma_ double _lv ) {
   double _lmbet;
 _lmbet = mtau_inv * exp ( - ( _lv - mv_05 ) / 27.0 ) ;
...
double half ( _threadargsprotocomma_ double _lv ) {
   double _lhalf;
 _lhalf = htau_inv * exp ( - ( _lv - hv_05 ) / 33.0 ) ;
...
double hbet ( _threadargsprotocomma_ double _lv ) {
   double _lhbet;
 _lhbet = htau_inv * exp ( ( _lv - hv_05 ) / 12.2 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/nainter.mod";
static const char* nmodl_file_text = 
