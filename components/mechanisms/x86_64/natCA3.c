...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 natCA3 /home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/natCA3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/natCA3.mod";
static const char* nmodl_file_text = 
  "TITLE nat\n"
  ": Na current \n"
  ": from Jeff M.\n"
