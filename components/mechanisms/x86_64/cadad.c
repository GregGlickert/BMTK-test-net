...
#define nrn_init _nrn_init__cadad
#define _nrn_initial _nrn_initial__cadad
#define nrn_cur _nrn_cur__cadad
#define _nrn_current _nrn_current__cadad
#define nrn_jacob _nrn_jacob__cadad
#define nrn_state _nrn_state__cadad
#define _net_receive _net_receive__cadad 
#define state state__cadad 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadad /home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/cadad.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/cadad.mod";
static const char* nmodl_file_text = 
