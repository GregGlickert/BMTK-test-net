...
#define setRandObj setRandObj__Gfluct2 
...
#define i_exc _p[8]
#define i_exc_columnindex 8
#define i_inh _p[9]
#define i_inh_columnindex 9
#define g_e _p[10]
...
#define noise_e _p[20]
#define noise_e_columnindex 20
#define noise_i _p[21]
#define noise_i_columnindex 21
#define v _p[22]
...
#define normrand123 normrand123_Gfluct2
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "bbcorepointer");
 	...
 	ivoc_help("help ?1 Gfluct2 /home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/Gfluct.mod\n");
...
static int setRandObj(_threadargsproto_);
 ...
 static void _ba1(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, NrnThread* _nt)  {
  ...
  v = NODEV(_nd);
 noise_e = normrand123 ( _threadargs_ ) ;
   noise_i = normrand123 ( _threadargs_ ) ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/gjgpb9/BMTK-test-net/components/mechanisms/modfiles_core/Gfluct.mod";
static const char* nmodl_file_text = 
